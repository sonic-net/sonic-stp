...
void mstputil_compute_message_digest(bool print)
{
    ...
    snprintf(buffer, 36, "0x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x",
            mstp_bridge->mstConfigId.config_digest[0],
            mstp_bridge->mstConfigId.config_digest[1],
            mstp_bridge->mstConfigId.config_digest[2],
            mstp_bridge->mstConfigId.config_digest[3],
            mstp_bridge->mstConfigId.config_digest[4],
            mstp_bridge->mstConfigId.config_digest[5],
            mstp_bridge->mstConfigId.config_digest[6],
            mstp_bridge->mstConfigId.config_digest[7],
            mstp_bridge->mstConfigId.config_digest[8],
            mstp_bridge->mstConfigId.config_digest[9],
            mstp_bridge->mstConfigId.config_digest[10],
            mstp_bridge->mstConfigId.config_digest[11],
            mstp_bridge->mstConfigId.config_digest[12],
...
/*****************************************************************************/
/* mstputil_is_boundaryPort: checks if the input port is a boundary port 		*/
/*****************************************************************************/
bool mstputil_is_boundaryPort(PORT_ID port_number)
{
	MSTP_PORT *mstp_port = mstpdata_get_port(port_number);
	if((mstp_port->operEdge == false) && (mstp_port->rcvdInternal == false))
		return true;
	else
		return false;
}
...
/*****************************************************************************/
/* mstputil_is_operPt2pt_port: checks if the input port is operationally a   */
/* point-to-point link                                                       */
/*****************************************************************************/
bool mstputil_is_operPt2pt_port(PORT_ID port_number)
{
	MSTP_PORT *mstp_port = mstpdata_get_port(port_number);
	return (mstp_port && mstp_port->operPt2PtMac);
}
