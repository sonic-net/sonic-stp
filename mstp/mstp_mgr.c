...
/*****************************************************************************/
/* mstpmgr_reset_port_state: sets the ports to blocking when mstp is stopped */
/*****************************************************************************/
bool mstpmgr_reset_port_state(PORT_ID port_number)
{
    MSTP_INDEX mstp_index;
    MSTP_PORT *mstp_port;
    ...
    mstputil_set_port_state(MSTP_INDEX_CIST, port_number, BLOCKING);
    for (mstp_index = MSTP_INDEX_MIN; mstp_index <= MSTP_INDEX_MAX; mstp_index++)
    {
...
bool mstpmgr_set_control_mask(MSTP_INDEX mstp_index)
{
    ...
    mstp_bridge = mstpdata_get_bridge();
    clear_mask(del_mask); clear_mask(add_mask);
