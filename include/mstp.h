...
#define MSTP_INVALID_REGION_ID				0xFF
#define MSTP_INVALID_REGION_ID_FOR_CLI 		MSTP_SINGLE_REGION_ID
...
{
	MSTP_ROLE_MASTER        = 0,
	MSTP_ROLE_ALTERNATE     = 1,
	MSTP_ROLE_ROOT          = 2,
	MSTP_ROLE_DESIGNATED    = 3,
	MSTP_ROLE_BACKUP,
	MSTP_ROLE_DISABLED
} MSTP_ROLE;
...
typedef enum
{
	...
	MSTP_PRS_ROLE_SELECTION // MSTP_BUG
} MSTP_PRS_STATE;
